...
const char ssid[] = "แก้ชื่อ Wi-Fi";        // Your Wi-Fi SSID
const char pass[] = "ใส่รหัสการเชื่อมต่อ Wi-Fi";   // Your Wi-Fi password
const char auth[] = "ใส่ Auth Token เอามาจาก blynk"; // Auth token from Blynk app
...
// Create LCD instance (I2C address: 0x27, 16 columns, 2 rows)
...
void setup() {
  ...
  Blynk.begin(auth, ssid, pass, "ip address ของ blynk server", 8080);
